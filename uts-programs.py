...
class PageCalc(Page):
    ...
    def _build(self):
        ...
        for lbl, key, clr, fnt in specs:
            ...
            tk.Label(row, textvariable=var, font=fnt,
                     bg=SURFACE2, fg=clr, anchor="e").pack(side="right", fill="x", expand=True)
        ...
        for (lbl,c,r,cs,color) in keys:
            ...
            b.bind("<Enter>", lambda e,b=b,lc=lighter: b.config(bg=lc))
            b.bind("<Leave>", lambda e,b=b,oc=color:   b.config(bg=oc))
